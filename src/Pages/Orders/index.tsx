...
import { OrderListProps, OrderProps } from '../../Interfaces';
import { ContextApp } from '../../Context';


export const Orders: React.FC<OrderListProps> = ({orders}) => {
 const{handleAsideOrderDetail} = useContext(ContextApp);
    ...
    <Layout>
      ...
      <div className="flex flex-wrap w-4/5 gap-4 h-52 items-center cursor-pointer">
        {orders && orders.map((order: OrderProps) => (
          ...
          onClick={()=>handleAsideOrderDetail(order)}
          >
